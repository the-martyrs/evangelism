<h1 align="center"><img src="assets/thumbnail.jpg" height="450px" width="100%" style="object-fit: cover; border-radius: 5px" alt="The Martyrs Evangelism " /></h1>

## Documentation

For detailed information on how to use this project, a documentation is currently being worked on

## Demo

A live demonstration of what you will have when starting a project with 🚀 This project will be available on [evangelism.vercel.app](https://evangelism.vercel.app)
...
```bash
git clone https://github.com/The-Martyrs-Media-Team/evangelism.git
```
...
1. Build the Docker image (replace `evangelism` with your project name)
```
docker build -t evangelism .
```

2. Run the Docker image (replace `evangelism` with your project name)
```
docker run -p 80:3000 evangelism
```
