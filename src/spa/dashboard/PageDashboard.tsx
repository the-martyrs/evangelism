      ...
      <PageContent>
        ...
        <Alert status="success" colorScheme="brand" borderRadius="md">
          ...
          <Box flex="1">
            ...
            <AlertDescription display="block">
              ...
              <Text
                as="a"
                href="https://github.com/The-Martyrs-Media-Team"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <Wrap mt="4" spacing="4">
          <Button
            variant="link"
            as="a"
            href="https://github.com/The-Martyrs-Media-Team/evangelism"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <Button
            variant="link"
            as="a"
            href="https://github.com/The-Martyrs-Media-Team/evangelism/issues/new"
            target="_blank"
            rel="noreferrer"
          >
